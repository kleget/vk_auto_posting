...
async def change_sponsor_3(callback_query: types.CallbackQuery):
    ...
    await bot.edit_message_text(chat_id='1277447609', message_id=callback_query.message.message_id, text='Отправь нового спонсора (rm - удалить):', reply_markup=keyboard)
